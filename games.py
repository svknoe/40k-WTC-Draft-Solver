...
def select_defender(n, select_attackers_strategies, friends, enemies):
    size = len(friends)
    if len(enemies) != size:
...
def select_attackers(n, discard_attacker_strategies, f_defender, remaining_friends, e_defender, remaining_enemies):
        ...
        for j in range(i + 1, size):
            ...
            for k in range(0, size - 1):
                ...
                for l in range (k + 1, size):
                    ...
                    friendly_team_permutation = TeamPermutation(unselected_friends, f_defender, f_attacker_A, f_attacker_B)
                    enemy_team_permutation = TeamPermutation(unselected_enemies, e_defender, e_attacker_A, e_attacker_B)
                    game_permutation = GamePermutation(friendly_team_permutation, enemy_team_permutation)
...
def discard_attacker(matrix, n, select_defender_strategies, f_defender, f_attacker_A, f_attacker_B, other_friends, e_defender, e_attacker_A, e_attacker_B, other_enemies):
    ...
    if n == 4:
        return discard_attacker_4(matrix, f_defender, f_attacker_A, f_attacker_B, other_friends[0], e_defender, e_attacker_A, e_attacker_B, other_enemies[0])
